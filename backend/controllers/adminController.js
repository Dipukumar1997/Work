...
export const searchStudent = async (req, res) => {
  try {
    ...
    const student = await Student.findOne({ rollNumber }).populate('userId', 'email');
...
// @desc    Update student edit permissions
// @route   PUT /api/admin/students/:id/permissions
// @access  Private (Admin)
export const updateStudentPermissions = async (req, res) => {
  try {
    const { editPermissions } = req.body;
